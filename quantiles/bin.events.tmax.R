...
tmax.daily <- readRDS("/oceano/gmeteo/users/fuentesm/ERA5/ERA5-LAND/data/basic/tmax.daily.hottest.month.pi.era5.land.rds")
tmax.q90 <- readRDS("/oceano/gmeteo/users/fuentesm/ERA5/ERA5-LAND/data/quantiles/tmax.q90.monthly.pi.1986.2005.rds")
...
# Save the results
saveRDS(list.total, "ERA5-LAND/data/basic/tmax.bin.pi.1986.2005.era5.land.rds", compress="xz")
...
# Plot the results
png("ERA5-LAND/data/basic/tmax.events.png", width=1200, height=800)
